...
class Table {
   ...
   private:
     // Your code here.
	   int maxsize;                  // the capacity of the table
	   int count;                    // the number of used slots
	   int**  entries;              // the entries of objects stored in the table
	   Lock* lock;
	   Condition* condition;         // condition variable on table is full
};
